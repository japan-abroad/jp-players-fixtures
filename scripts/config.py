...
# イングランドのクラブは国別トップリーグ推定(COUNTRY_TOP_LEAGUE_JA)だと
# 常にプレミアリーグ扱いになってしまい、チャンピオンシップ以下のクラブが
# 誤ってプレミアリーグ所属と表示される事故が発覚した(2026-09-09)。
# イングランドのみ /leagues?team=X&season=Y で実際の所属ディビジョンを
# 確認し、このIDから表示名を引く。
ENGLAND_DIVISION_JA = {
    39: "プレミアリーグ",
    40: "チャンピオンシップ",
...
# API-Football無料プランはシーズン2022〜2024しか参照できない(season=2025/2026は
# 拒否される)ため、ENGLAND_DIVISION_JAによる自動判定は2024-25シーズン時点の
# ディビジョンに固定されてしまい、シーズンが進むごとに実態とズレていく。
# 昇降格が確認できたクラブはWeb検索等で裏取りのうえteam_id単位でここに
# 上書きを追加すること(2026-09-09、2026-27シーズン時点で確認・ユーザー指摘により追加)。
ENGLAND_DIVISION_OVERRIDE_BY_TEAM_ID: dict[int, str] = {
    63: "プレミアリーグ",  # Leeds United: 2025-26に昇格、2026-27も残留
    64: "プレミアリーグ",  # Hull City: 2026-27に昇格
    1346: "プレミアリーグ",  # Coventry City: 2026-27に昇格
    54: "チャンピオンシップ",  # Birmingham City: 2025-26にリーグ1から昇格
    68: "チャンピオンシップ",  # Bolton Wanderers: 2025-26にリーグ1からプレーオフ昇格
    41: "チャンピオンシップ",  # Southampton: 2024-25限りでプレミアリーグから降格
}
